...
import { Search as SearchIcon, Music, Loader2 } from 'lucide-react';
        ...
        <div className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl overflow-hidden divide-y divide-zinc-100 dark:divide-zinc-900 animate-in fade-in slide-in-from-top-2 duration-300">
          {results.slice(0, 6).map((track) => (
            <button
              ...
              className="flex w-full items-center p-4 text-left hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-colors group"
            >
              ...
              <div className="ml-4 flex-1 min-w-0">
                <h4 className="font-bold text-zinc-900 dark:text-white truncate uppercase italic tracking-tighter">
                  {track.title}
                </h4>
              ...
              <span className="ml-4 shrink-0 text-[10px] font-bold uppercase tracking-widest text-[#0B4D2E] dark:text-[#3DCF7A]">
                Learn a word
              </span>
            </button>
          ))}
